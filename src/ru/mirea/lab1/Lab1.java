...
public class Lab1 {
    public static void main(String[] args) {
        ...
        int choice = 0; // Инициализируем choice нулем, чтобы объявить его за пределами try-catch.

        while (true) {
            try {
                System.out.println("Введите число от 2 до 8:");
                choice = scanner.nextInt();

                if (choice >= 2 && choice <= 8) {
                    break; // Если введено корректное число, выходим из цикла.
                } else {
                    System.out.println("Число должно быть от 2 до 8. Пожалуйста, попробуйте снова.");
                }
